...
public class YouTubeService : IYouTubeService
{
    ...
    public async Task<YouTubeAnalysisResponse> GetDetailedAnalysisAsync(string topic, YouTubeSearchFilters? filters = null)
    {
        ...
        string cacheKey = $"yt_analysis_{normalizedTopic}_{filters?.RegionCode}_{filters?.Language}_{filters?.MaxResults}_{filters?.PublishedAfter?.Ticks}";
        ...
        try
        {
            ...
            // 2. Prepare Video and Channel requests
            ...
            // 3. Execute Video and Channel requests in parallel
