...
public class YouTubeService : IYouTubeService
{
    ...
    {
        // ⚡ Bolt Optimization: Use IMemoryCache to store results of expensive API calls
        // Normalize the topic for consistent cache keys
        ...
        {
            _logger.LogInformation("Returning cached YouTube analysis for {Topic}", topic);
        ...
        try
        {
            ...
            if (!videoIds.Any())
            {
                ...
                _cache.Set(cacheKey, emptyResponse, TimeSpan.FromMinutes(10));
                return emptyResponse;
            }

            // ⚡ Bolt Optimization: Parallelize independent I/O-bound tasks using Task.WhenAll
