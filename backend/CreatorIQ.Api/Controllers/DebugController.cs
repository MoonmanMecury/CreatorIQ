...
public class DebugController : ControllerBase
{
    ...
    public async Task<IActionResult> TestPython()
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "An internal error occurred while checking Python version." });
        }
    }
    ...
    public async Task<IActionResult> TestPytrends()
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "An internal error occurred while checking Pytrends." });
        }
    }
    ...
    public IActionResult TestError()
    {
        ...
        return StatusCode(500, new { error = "This is a test generic error response." });
    }
}
