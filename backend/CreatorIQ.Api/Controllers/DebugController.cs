...
public class DebugController : ControllerBase
{
    ...
    public async Task<IActionResult> TestPython()
    {
        ...
        {
            return StatusCode(500, new { error = "An internal error occurred during Python execution test." });
        }
    }
    ...
    public async Task<IActionResult> TestPytrends()
    {
        ...
        {
            return StatusCode(500, new { error = "An internal error occurred during Pytrends test." });
        }
    }
