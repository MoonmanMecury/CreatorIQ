...
public class DebugController : ControllerBase
{
    ...
    public async Task<IActionResult> TestPython()
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "Internal server error during python execution test." });
        }
    }
    ...
    public async Task<IActionResult> TestPytrends()
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "Internal server error during pytrends import test." });
        }
    }
    ...
    public IActionResult TestError()
    {
        ...
        return StatusCode(500, new { error = "A simulated internal server error occurred." });
    }
}
