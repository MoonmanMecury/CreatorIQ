...
public class DebugController : ControllerBase
{
    ...
    public async Task<IActionResult> TestPython()
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "An error occurred while testing Python execution." });
        }
    }
    ...
    public async Task<IActionResult> TestPytrends()
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "An error occurred while testing Pytrends availability." });
        }
    }
