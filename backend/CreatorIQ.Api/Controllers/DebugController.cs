...
public class DebugController : ControllerBase
{
    ...
    public async Task<IActionResult> TestPython()
    {
        ...
        {
            _logger.LogError(ex, "Python version test failed.");
            return StatusCode(500, new { error = "Internal server error occurred while testing Python." });
        }
    }
    ...
    public async Task<IActionResult> TestPytrends()
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "Internal server error occurred while testing Pytrends." });
        }
    }
